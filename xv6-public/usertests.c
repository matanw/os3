...
This test will take a lot of time unless:

a) Makefile's CPUS definition reduces the number of CPUs:
CPUS := 1

b) -snapshot option is added to the definition of QEMUOPTS:
